...
class Parser(object):
    ...
    def parse(self, dataset, eval_batch_size=5000, device="cpu"):
        sentences = []
        sentence_id_to_idx = {}
        ...
        model = ModelWrapper(self, dataset, sentence_id_to_idx, device=device)
...
class ModelWrapper(object):
    def __init__(self, parser, dataset, sentence_id_to_idx, device="cpu"):
        self.parser = parser
